<?php
    ...
    $args = array(
        ...
        'page_title'           => __( 'My consultion Options', 'redux-framework-demo' ),
        ...
        'admin_bar_icon'       => 'dashicons dashicons-archive',
        ...
        'menu_icon'            => get_template_directory_uri(). '/images/datatrix-them-icon.png',
        // Specify a custom URL to an icon
        'last_tab'             => '',
        // Force your panel to always open to a specific tab (by id)
        'page_icon'            => 'icon-themes',
        // Icon displayed in the admin panel next to your menu_title
        'page_slug'            => 'Datatrixsoft',
    ...
    redux::setSection($opt_name,array(
        ...
        'id'=>'favicon-gallery',
        'type'=>'select-image',
        'desc'=>'Select your favicon icon as you like',
        'subsection'=>true,
        'icon'=>__('el el-paper-clip', 'SR'),
        'fields'=>array(
            array(
                'id'=>'opt-favicon',
                'type'=>'gallery',
                'title'=>__('Set the favicon logo', 'SR'),
                'subtitle'=>__('This is favicon section area', 'SR'),
                'desc'=>__('set the favicon as your own', 'SR'),
